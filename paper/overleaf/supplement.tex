...
\path{table26_stress_structure_sensitivity.csv} & Assumption-block and dependence designs & Triangular-marginal sensitivity; not empirical probability \\
\end{longtable}
}
